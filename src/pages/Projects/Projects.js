...
const Project = () => {
    return (
        <div>
           <h3 id='project' className="text-center mt-5" style={{fontSize:"30px",fontWeight:'bold', fontFamily:'cursive'}}>My Projects <span style={{fontSize:"30px",fontWeight:'bold',color:'#0FDCDC'}}>Work</span></h3>
